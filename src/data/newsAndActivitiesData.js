...
export const newsAndActivitiesData = [
  {
    ...
    description: "We are working to empower 100,000 smallholder cocoa farmers in Ghana by raising under-represented voices and connecting farmers with the knowledge they need to build resilient, inclusive and thriving cocoa communities through the power of participatory local-language FM radio.",
    fullContent: [
  ...
  },
  {
    ...
    description: "Participatory Development Associates (PDA), in partnership with the Department of Children under the Ministry of Gender, Children and Social Protection, convened the 8th Knowledge Sharing Workshop on Child Protection (KSWoCP) with two multi-level events in Accra and Bechem.",
    fullContent: [
  ...
  },
  {
    ...
    description: "On June 20, 2025, over 20 staff members from PDA and PDA Africa participated in a critical training session facilitated by representatives from Ghana's Data Protection Commission.",
    fullContent: [
  ...
  },
  {
    ...
    description: "Despite increasing school enrollment rates, Ghana continues to face significant challenges in foundational literacy and numeracy, particularly at the primary level.",
    fullContent: [
  ...
  },
  {
    ...
    title: "PDA Signs Memorandum of Understanding (MOU) with the Institute for Diversity and Inclusion in Emergency Management (I-DIEM)",
    description: "In an effort to strengthen disaster resilience and foster inclusive community development, Participatory Development Associates (PDA) has entered into a Memorandum of Understanding (MOU) with the Institute for Diversity and Inclusion in Emergency Management (I-DIEM).",
    fullContent: [
  ...
  },
  {
    ...
    title: "Edem Agbe Advocates for African-Led Evaluation at the German Institute for Development Evaluation (VENRO-DEval) Workshop 2024",
    description: "On October 10th and 11th, 2024, the German Institute for Development Evaluation (DEval) in partnership with VENRO convened experts and practitioners in Bonn, Germany, for a workshop that explored 'Partner Orientation and Decolonization in Evaluations.'",
    fullContent: [
  ...
  },
  {
    ...
    description: "Over the past three decades, Ghana's Parliament, in partnership with civil society organizations (CSOs) and development partners, has sought to bridge the gap between citizens and their elected representatives.",
    fullContent: [
  ...
  },
  {
    ...
    description: "In partnership with A Rocha Ghana, PDA's Research Evaluation and Learning Unit is strengthening the capacities of nine (9) partner organizations (NGOs & CBOs) to support their quest to rally communities to combat the exploitation of natural reserves.",
    fullContent: [
  ...
  },
  {
    ...
    description: "Tony's Chocolonely (Tony's), a Dutch social enterprise, was founded in response to the distressing reality of child labor and modern slavery in cocoa plantations in West Africa.",
    fullContent: [
